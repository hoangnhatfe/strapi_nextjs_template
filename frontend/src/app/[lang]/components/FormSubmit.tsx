          ...
          {successMessage ? (
            ...
            <>
              <input
                ...
                value={email}
                className={"w-3/5 p-3 rounded-l-lg sm:w-2/3 text-gray-700 border border-gray-400"}
              />
              <button
                type="button"
                className="w-2/5 p-3 font-semibold rounded-r-lg sm:w-1/3 bg-blue-400 text-white"
